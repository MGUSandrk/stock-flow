    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Link href="/dashboard/inventory" className="group">
          <div className="flex flex-col items-center justify-center p-8 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm hover:shadow-md hover:border-fuchsia-500 dark:hover:border-fuchsia-500 transition-all duration-300">
            <div className="p-4 bg-neutral-100 dark:bg-neutral-800 rounded-full mb-4 group-hover:bg-fuchsia-100 dark:group-hover:bg-fuchsia-900/50 transition-colors">
              <ShoppingBag className="w-8 h-8 text-neutral-500 dark:text-neutral-400 group-hover:text-fuchsia-600 dark:group-hover:text-fuchsia-400" />
            </div>
        ...
        <Link href="/dashboard/products/add" className="group">
          <div className="flex flex-col items-center justify-center p-8 bg-white dark:bg-neutral-900 rounded-xl border border-neutral-200 dark:border-neutral-800 shadow-sm hover:shadow-md hover:border-blue-500 dark:hover:border-blue-500 transition-all duration-300">
            <div className="p-4 bg-neutral-100 dark:bg-neutral-800 rounded-full mb-4 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50 transition-colors">
              <PlusCircle className="w-8 h-8 text-neutral-500 dark:text-neutral-400 group-hover:text-blue-600 dark:group-hover:text-blue-400" />
            </div>
