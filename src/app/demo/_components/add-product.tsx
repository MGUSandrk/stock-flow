...
export function ProductForm() {
  ...
  const handleCreateCategory = async () => {
    ...
    setLoading(true);
    alert("Función de creación de categoría no implementada en este demo. Se cerrará el modal.")
    setLoading(false);
  }
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    alert("Función de creación de producto no implementada en este demo. Se redirigirá al inventario.")
    setLoading(false)
